...
resources_controller.dateToTs2 = (date) => {
    let current_datetime = new Date(date)
...
resources_controller.CambiarFechaJson2 = (valorABuscar, json) => {
    json.forEach(function (elemento) {
        elemento[valorABuscar] = resources_controller.dateToTs2(new Date(elemento[valorABuscar]))
    })
}


resources_controller.CambiarRole = (valorABuscar, json) => {
    json.forEach(function (elemento) {
        if(elemento[valorABuscar] === 0){
            elemento[valorABuscar] = "Inactivo"
        }else{
            elemento[valorABuscar] = "Activo"
        }
    })
}
