    ...
    getUsers = async () => {
        try {
            ...
            if (res.data.status === "error") {
                ...
                resources_controller.CambiarFechaJson2("birthdate", data)
                resources_controller.CambiarRole("active_ind", data)
                this.setState({
                    datatable: {
                        columns: [
                            {
    ...
    handleUpdateModal = () => {
        this.setState({
            ...
            form: {
                ...
                cellphone: this.state.checkbox.cellphone,
                sex: this.state.checkbox.sex,
                birthdate: this.state.checkbox.birthdate,
                house_address: this.state.checkbox.house_address,
                password: "",
                role: this.state.checkbox.role,
            },
        })
    }
    handleInsertModal = () => {
